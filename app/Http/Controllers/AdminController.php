...
class AdminController extends Controller
{
   ...
   public function add_category(Request $request)
   {
     ...
     // toastr()->info(' Category Added Successfully');
      //
      //toastr()->closeButton()->addWarning(' Category Added Successfully');
   ...
   public function delete_category($id)
   {
        ...
        toastr()->timeOut(10000)->closeButton()->addSuccess(' Category Delited Successfully');
   ...
   public function upload_product(Request $request)
   {
        ...
        $data->save();
        toastr()->timeOut(10000)->closeButton()->addSuccess(' Product Upload Successfully');
   ...
   public function edit_product(Request $request,$id)
   {
    ...
    $data->save();
    toastr()->timeOut(10000)->closeButton()->addSuccess(' Product Update Successfully');
...
return view('admin.view_product',compact('product'));
   ...
   public function view_orders() // This is the correct method name
   {
    $data = Order::all();
